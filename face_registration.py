...
class FaceRegistration:
    ...
    def register_face_id(self):
        ...
        try:
            ...
            predictor = dlib.shape_predictor("D:/HK2_2025/DACN_Project/shape_predictor_68_face_landmarks.dat/shape_predictor_68_face_landmarks.dat")
            ...
            def detect_liveness():
                ...
                if sharpness < 50:
                    messagebox.showerror("Warning", "Detected a printed photo! Please use a real face.",
                                         parent=self.root)
                    self.stop_face_scan()
                    return
